...
export function NotificationBell() {
  ...
  const getIcon = (type: NotificationType) => {
    switch (type) {
      case NotificationType.NEW_COMPLAINT: return <AlertCircle className="text-blue-600" size={18} />;
      ...
      default: return <Info className="text-zinc-600" size={18} />;
    }
  };
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-80 bg-white rounded-3xl shadow-2xl shadow-zinc-200 border border-zinc-100 overflow-hidden z-50"
          >
                ...
                <div className="divide-y divide-zinc-50">
                  {notifications.map((n) => (
                    <div
                      key={n.id}
                      className={cn(
                        "p-4 hover:bg-zinc-50 transition-colors cursor-pointer relative group",
                    ...
                    >
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className={cn("text-sm mb-1", !n.is_read ? "font-bold text-zinc-900" : "text-zinc-600")}>
                            {n.title}
                          </p>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            {n.link && (
                              <Link
                                ...
                                className="text-[10px] font-bold text-blue-600 flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity"
                              >
